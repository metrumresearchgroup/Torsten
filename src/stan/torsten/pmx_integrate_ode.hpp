#ifndef STAN_LANG_AST_NODE_TORSTEN_INTEGRATE_ODE_HPP
#define STAN_LANG_AST_NODE_TORSTEN_INTEGRATE_ODE_HPP
...
namespace stan {
  namespace lang {
    ...
    struct pmx_integrate_ode {
       ...
       */
      pmx_integrate_ode(const std::string& integration_function_name,
