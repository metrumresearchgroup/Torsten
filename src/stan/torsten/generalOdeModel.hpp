#ifndef STAN_LANG_AST_NODE_GENERALODEMODEL_HPP
#define STAN_LANG_AST_NODE_GENERALODEMODEL_HPP
...
namespace stan {
  namespace lang {
    ...
    struct generalOdeModel {
      ...
      /**
       * Construct a default ODE integrator object with default.
       */
      generalOdeModel();
       ...
       */
      generalOdeModel(const std::string& integration_function_name,
