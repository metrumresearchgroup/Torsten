    ...
    , [ ( AutoDiffable
        , UFun
            ( [ (AutoDiffable, UReal)
              ...
              ; (DataOnly, UArray UReal); (DataOnly, UArray UInt) ]
            , ReturnType (UArray UReal) ) )
      ; (AutoDiffable, UArray UReal) (* y0 *)
      ; (AutoDiffable, UReal)        (* t0 *)
      ; (AutoDiffable, UArray UReal) (* ts *)
      ; (AutoDiffable, UArray UReal) (* theta *)
      ; (DataOnly, UArray UReal)     (* x_ *)
      ; (DataOnly, UArray UInt) ] ) ; (* x_i *)
  add_qualified
    ( "pmx_integrate_ode_adams"
    , ReturnType (UArray (UArray UReal))
    , [ ( AutoDiffable
    ...
    , [ ( AutoDiffable
        , UFun
            ( [ (AutoDiffable, UReal)
              ...
              ; (DataOnly, UArray UReal); (DataOnly, UArray UInt) ]
            , ReturnType (UArray UReal) ) )
      ; (AutoDiffable, (UArray (UArray UReal))) (* y0 *)
      ; (AutoDiffable, UReal)                   (* t0 *)
      ; (DataOnly, UArray UInt)                 (* len *)
      ; (AutoDiffable, UArray UReal)            (* ts *)
      ; (AutoDiffable, (UArray (UArray UReal))) (* theta *)
      ; (DataOnly, (UArray (UArray UReal)))     (* x_r *)
      ; (DataOnly, (UArray (UArray UInt)))      (* x_i *)
      ; (DataOnly, UReal)            (* rtol *)
      ; (DataOnly, UReal)            (* atol *)
      ; (DataOnly, UReal) ] ) ;      (* mxstep *)
  add_qualified
...
(* pmx_solve_adams *)
  ...
  add_qualified
    ...
    , [ ( AutoDiffable
      ...
      ; (DataOnly, UArray UInt)                  (* addl *)
      ; (DataOnly, UArray UInt)                  (* ss *)
      ; (AutoDiffable, UArray UReal)            (* pMatrix *)
