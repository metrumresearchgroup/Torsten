...
TEST(univariate_integral, const_example) {
  ...
  EXPECT_NEAR(5.0, stan::math::univariate_integral(f, theta, t0, t1), 1e-5);
}
...
TEST(univariate_integral, linear_example) {
  ...
  EXPECT_NEAR(3.75, stan::math::univariate_integral(f, theta, t0, t1), 1e-5);
}
...
TEST(univariate_integral, quad_example) {
  ...
  EXPECT_NEAR(1.112, stan::math::univariate_integral(f, theta, t0, t1), 1e-5);
}
