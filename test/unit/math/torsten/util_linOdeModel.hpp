#ifndef TEST_UNIT_MATH_TORSTEN_UTIL_LINODEMODEL_HPP
#define TEST_UNIT_MATH_TORSTEN_UTIL_LINODEMODEL_HPP
...
finite_diff_params(const std::vector<double>& time,
  ...
  pk_res_ub = linCptModel(time, amt, rate, ii, evid, cmt, addl, ss,
                          system_ub, biovar_ub, tlag_ub);
  pk_res_lb = linCptModel(time, amt, rate, ii, evid, cmt, addl, ss,
...
void test_linearOdeModel_finite_diff_vdd(
  ...
  Matrix<var, Dynamic, Dynamic> ode_res
    = linCptModel(time, amt, rate, ii, evid, cmt, addl, ss,
...
void test_linearOdeModel_finite_diff_dvd(
  ...
  Matrix<var, Dynamic, Dynamic> ode_res;
  ode_res = linCptModel(time, amt, rate, ii, evid, cmt, addl, ss,
