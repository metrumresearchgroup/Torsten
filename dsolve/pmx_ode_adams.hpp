#ifndef STAN_MATH_TORSTEN_ODE_ADAMS_HPP
#define STAN_MATH_TORSTEN_ODE_ADAMS_HPP
...
namespace torsten {
  ...
  pmx_ode_adams_ctrl(const F& f,
    ...
    PMXOdeIntegrator<PMXVariadicOdeSystem, PMXCvodesIntegrator<CV_ADAMS, CV_STAGGERED>> solver(rtol, atol, max_num_step, msgs);
