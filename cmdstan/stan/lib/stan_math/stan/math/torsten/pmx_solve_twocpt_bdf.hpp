#ifndef STAN_MATH_TORSTEN_TWOCPT_BDF_HPP
#define STAN_MATH_TORSTEN_TWOCPT_BDF_HPP
...
pmx_solve_twocpt_bdf(const F& f,
  ...
  // check arguments
  static const char* function("pmx_solve_twocpt_bdf");
  ...
  /*
   * overload with default ode & algerba solver controls
   */
template <typename T0, typename T1, typename T2, typename T3, typename T4,
          typename T5, typename T6, typename F>
stan::matrix_return_t<T0, T1, T2, T3, T4, T5, T6>
...
pmx_solve_twocpt_bdf(const F& f,
  ...
  /**
   * Overload function to allow user to pass an std::vector for 
   * pMatrix/bioavailability/tlag, with default algebra solver controls
   */
  template <typename T0, typename T1, typename T2, typename T3,
            typename T_par, typename T_biovar, typename T_tlag,
            typename F,
