...
TYPED_TEST_P(test_twocpt, single_bolus_tlag) {
  ...
  this -> test_finite_diff_tlag(1.e-3, 1.5e-4);
}
...
TYPED_TEST_P(test_twocpt, multiple_bolus_cent) {
  ...
  this -> test_finite_diff_biovar(1.e-3, 1.e-6);
  this -> test_finite_diff_tlag(1.e-3, 5.e-5);
}
...
TYPED_TEST_P(test_twocpt, multiple_bolus_tlag) {
  ...
  this -> test_finite_diff_amt(1.e-3, 1.e-6);
  this -> test_finite_diff_theta(1.e-3, 5.e-4);
  this -> test_finite_diff_biovar(1.e-3, 1.e-6);
  this -> test_finite_diff_tlag(1.e-3, 8.e-4);
}
...
TYPED_TEST_P(test_twocpt, multiple_infusion_addl) {
  ...
  this -> test_finite_diff_theta(1.e-3, 1.e-6);
  this -> test_finite_diff_biovar(1.e-3, 1.e-6);
  this -> test_finite_diff_ii(1.e-3, 1.e-4);
}
...
TYPED_TEST_P(test_twocpt, multiple_infusion) {
  ...
  this -> test_finite_diff_amt(1.e-3, 1.e-6);
  this -> test_finite_diff_rate(1.e-3, 1.e-6);
  this -> test_finite_diff_theta(1.e-3, 5.e-5);
  this -> test_finite_diff_biovar(1.e-3, 1.e-6);
}
