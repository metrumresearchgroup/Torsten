...
// INSTANTIATE_TYPED_TEST_SUITE_P(TorstenODE, harmonic_oscillator_t0_ad_test,
...
INSTANTIATE_TYPED_TEST_SUITE_P(TorstenODE, harmonic_oscillator_analytical_test,
                               harmonic_oscillator_test_types);
