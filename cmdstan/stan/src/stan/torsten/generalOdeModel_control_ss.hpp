#ifndef STAN_LANG_AST_NODE_GENERALODEMODEL_CONTROL_SS_HPP
#define STAN_LANG_AST_NODE_GENERALODEMODEL_CONTROL_SS_HPP
...
namespace stan {
  namespace lang {
     ...
     */
    struct generalOdeModel_control_ss {
      /**
      ...
      /**
       * Relative tolerance for algebra solver used in steady state (real).
       */
      expression ss_rel_tol_;

      /**
       * Absolute tolerance for algebra solver used in steady state (real).
       */
      expression ss_abs_tol_;

      /**
       * Maximum number of steps for algebra solver used in steady state (integer).
       */
      expression ss_max_num_steps_;
       ...
       * @param ss_rel_tol relative tolerance for the Boost ode solver 
       * @param ss_abs_tol absolute tolerance for the Boost ode solver
       * @param ss_max_num_steps maximal number of steps to take within 
       *   the Boost ode solver
       */
      generalOdeModel_control_ss(const std::string& integration_function_name,
