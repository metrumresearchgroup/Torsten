#ifndef STAN_LANG_AST_NODE_TORSTEN_PMX_INTEGRATE_ODE_CONTROL_HPP
#define STAN_LANG_AST_NODE_TORSTEN_PMX_INTEGRATE_ODE_CONTROL_HPP
...
namespace stan {
  namespace lang {
     ...
     */
    struct pmx_integrate_ode_control {
      /**
       ...
       */
      pmx_integrate_ode_control(const std::string& integration_function_name,
