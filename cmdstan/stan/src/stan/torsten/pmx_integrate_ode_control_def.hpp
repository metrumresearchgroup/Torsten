#ifndef STAN_LANG_AST_NODE_TORSTEN_INTEGRATE_ODE_CONTROL_DEF_HPP
#define STAN_LANG_AST_NODE_TORSTEN_INTEGRATE_ODE_CONTROL_DEF_HPP
...
namespace stan {
  namespace lang {
    ...
    pmx_integrate_ode_control::pmx_integrate_ode_control() { }

    pmx_integrate_ode_control::pmx_integrate_ode_control(const std::string& integration_function_name, // NOLINT
