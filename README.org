...
pharmacometric data. See [[https://github.com/metrumresearchgroup/Torsten/blob/master/docs/torsten_users_guide.pdf][the user guide]] for more details. A slightly
outdated web version can be found at
