...
The data are generated using the R package `mrgsolve` ([Baron and Gastonguay 2015](#org200243c)).
...
The MCMC history plots(Figure [1](#orge4f19a6))
...
data (Figure [3](#org6adaa7c)) are in close agreement with the
...
density can be examined in Figure [2](#org3a4aae5) and shows
...
exposure. As shown in Figure [fig:FK_model](#fig:FK_model), the Friberg-Karlsson Semi-Mechanistic model ([Friberg and Karlsson 2003](#org49ff31c)) couples
...
a PD effect(Figure [5](#org1f99f90)).
...
<a id="org200243c"></a>Baron, Kyle T., and Marc R. Gastonguay. 2015. “Simulation from ODE-Based Population PK/PD and Systems Pharmacology Models in R with Mrgsolve.” _Journal of Pharmacokinetics and Pharmacodynamics_ 42 (W-23):S84–85.

<a id="org49ff31c"></a>Friberg, Lena E., and Mats O. Karlsson. 2003. “Mechanistic Models for Myelosuppression.” _Investigational New Drugs_ 21 (2):183–94. <https://link.springer.com/article/10.1023/A:1023573429626>.
