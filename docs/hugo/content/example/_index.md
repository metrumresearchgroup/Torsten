...
lastmod = 2021-06-29T14:35:30-07:00
draft = false
weight = 1007
+++
...
The data are generated using the R package `mrgsolve` ([Baron and Gastonguay 2015](#org0aeecc4)).
...
The MCMC history plots(Figure [1](#org016d939))
...
data (Figure [3](#orge211e67)) are in close agreement with the
...
density can be examined in Figure [2](#org3037e84) and shows
...
### <span class="section-num">0.4</span> Joint PK-PD model {#sec:fk_model}
...
exposure. As shown in Figure [4](#org69f092f), the Friberg-Karlsson Semi-Mechanistic model ([Friberg and Karlsson 2003](#org9a0ab1d)) couples
...
{{< figure src="https://raw.githubusercontent.com/metrumresearchgroup/Torsten/master/docs/graphics/neutrophilModel.jpg" caption="Figure 4: Friberg-Karlsson semi-mechanistic Model." width="700" >}}
...
a PD effect(Figure [5](#orgfa2278a)).

<a id="orgfa2278a"></a>

{{< figure src="https://raw.githubusercontent.com/metrumresearchgroup/Torsten/master/docs/graphics/effCptModel.png" caption="Figure 5: Effect Compartment Model" width="400" >}}
...
chains. Figure [6](#orgf7da952) shows the posterior density of
the parameters.

Posterior prediction check (PPC) in Figure
[7](#org2660d0d) - [11](#org1d4a5ff) show that the fits to the plasma concentration
are in close agreement with the data, notably for the sparse data case (phase IIa study). The fits
to the PD data (Figure [12](#org406b6d7) - [16](#org642b902)) look
...
{{< figure src="https://raw.githubusercontent.com/metrumresearchgroup/Torsten/hugo_doc/example-models/effCpt/density.png" caption="Figure 6: Posterior marginal densities of the model parameters of the effect compartment model." width="700" >}}

<a id="org2660d0d"></a>

{{< figure src="https://raw.githubusercontent.com/metrumresearchgroup/Torsten/hugo_doc/example-models/effCpt/ppc_study_1_5mg.png" caption="Figure 7: Predicted (90% credible interval and median) and observed individual plasma drug concentrations in study 1 (5mg dose)." width="700" >}}

<a id="org39f1682"></a>

{{< figure src="https://raw.githubusercontent.com/metrumresearchgroup/Torsten/hugo_doc/example-models/effCpt/ppc_study_1_10mg.png" caption="Figure 8: Predicted (90% credible interval and median) and observed individual plasma drug concentrations in study 1 (10mg dose)." width="700" >}}

<a id="orgf48e0d2"></a>

{{< figure src="https://raw.githubusercontent.com/metrumresearchgroup/Torsten/hugo_doc/example-models/effCpt/ppc_study_1_20mg.png" caption="Figure 9: Predicted (90% credible interval and median) and observed individual plasma drug concentrations in study 1 (20mg dose)." width="700" >}}

<a id="org8bb395f"></a>

{{< figure src="https://raw.githubusercontent.com/metrumresearchgroup/Torsten/hugo_doc/example-models/effCpt/ppc_study_1_40mg.png" caption="Figure 10: Predicted (90% credible interval and median) and observed individual plasma drug concentrations in study 1 (40mg dose)." width="700" >}}

<a id="org1d4a5ff"></a>

{{< figure src="https://raw.githubusercontent.com/metrumresearchgroup/Torsten/hugo_doc/example-models/effCpt/ppc_study_2_20mg.png" caption="Figure 11: Predicted (90% credible interval and median) and observed individual plasma drug concentrations in study 2 (first 40 subjects)." width="700" >}}

<a id="org406b6d7"></a>

{{< figure src="https://raw.githubusercontent.com/metrumresearchgroup/Torsten/hugo_doc/example-models/effCpt/ppc_study_1_5mg_resp.png" caption="Figure 12: Predicted (90% credible interval and median) and observed individual PD response in study 1 (5mg dose)." width="700" >}}

<a id="org7f6b05a"></a>

{{< figure src="https://raw.githubusercontent.com/metrumresearchgroup/Torsten/hugo_doc/example-models/effCpt/ppc_study_1_10mg_resp.png" caption="Figure 13: Predicted (90% credible interval and median) and observed individual PD response in study 1 (10mg dose)." width="700" >}}

<a id="orged5dd37"></a>

{{< figure src="https://raw.githubusercontent.com/metrumresearchgroup/Torsten/hugo_doc/example-models/effCpt/ppc_study_1_20mg_resp.png" caption="Figure 14: Predicted (90% credible interval and median) and observed individual PD response in study 1 (20mg dose)." width="700" >}}

<a id="org7711de3"></a>

{{< figure src="https://raw.githubusercontent.com/metrumresearchgroup/Torsten/hugo_doc/example-models/effCpt/ppc_study_1_40mg_resp.png" caption="Figure 15: Predicted (90% credible interval and median) and observed individual PD response in study 1 (40mg dose)." width="700" >}}

<a id="org642b902"></a>

{{< figure src="https://raw.githubusercontent.com/metrumresearchgroup/Torsten/hugo_doc/example-models/effCpt/ppc_study_2_20mg_resp.png" caption="Figure 16: Predicted (90% credible interval and median) and observed individual PD response in study 2 (first 40 subjects)." width="700" >}}
...
{{< figure src="https://raw.githubusercontent.com/metrumresearchgroup/Torsten/hugo_doc/example-models/FribergKarlsson/density.png" caption="Figure 17: Posterior marginal densities of the model parameters of the Friberg-Karlsson population model." width="700" >}}

<a id="org72bf1ed"></a>

{{< figure src="https://raw.githubusercontent.com/metrumresearchgroup/Torsten/hugo_doc/example-models/FribergKarlsson/ppc_pk.png" caption="Figure 18: Predicted (50%, 90% credible interval and median) and observed individual drug plasma concentration." width="700" >}}

<a id="org66e4f5c"></a>

{{< figure src="https://raw.githubusercontent.com/metrumresearchgroup/Torsten/hugo_doc/example-models/FribergKarlsson/ppc_pd.png" caption="Figure 19: Predicted (50%, 90% credible interval and median) and observed individual Neutrophil counts." width="700" >}}
...
<a id="org0aeecc4"></a>Baron, Kyle T., and Marc R. Gastonguay. 2015. “Simulation from ODE-Based Population PK/PD and Systems Pharmacology Models in R with Mrgsolve.” _Journal of Pharmacokinetics and Pharmacodynamics_ 42 (W-23):S84–85.

<a id="org9a0ab1d"></a>Friberg, Lena E., and Mats O. Karlsson. 2003. “Mechanistic Models for Myelosuppression.” _Investigational New Drugs_ 21 (2):183–94. <https://link.springer.com/article/10.1023/A:1023573429626>.
