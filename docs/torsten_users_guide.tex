...
\newcommand\mrgsubtitle{\large{User's Guide} \linebreak (Torsten Version 0.91.1, Stan version 2.33.1)}
...
@misc{Torsten,
  ...
  title = {Torsten: A Pharmacokinetic/Pharmacodynamic Model Library for Stan (v0.91.1)},
  year  = {2025},
