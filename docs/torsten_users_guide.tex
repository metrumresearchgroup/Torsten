...
\newcommand\mrgsubtitle{\large{User's Guide} \linebreak (Torsten Version 0.92.0-rc1, Stan version 2.38.0)}
...
\large User's Guide \\  (Torsten Version 0.92.0, Stan version 2.38.0)}
\hypersetup{
 pdfauthor={Yi Zhang},
...
\begin{itemize}
\item \href{}{William R. Gillespie} , \href{https://www.metrumrg.com/}{Metrum Research Group}
\item \href{mailto:yz@yizh.org}{Yi Zhang} , \href{https://www.iconplc.com/solutions/technologies/nonmem/}{ICON plc}
\item \href{charles.margossian@stat.ubc.ca}{Charles Margossian} , \href{https://www.stat.ubc.ca/}{University of British Columbia}
\end{itemize}
...
\begin{itemize}
\item Current Torsten v0.92.0 is based on Stan v2.38.0.
...
\begin{itemize}
  \item Version 0.92.0 \textit{<2026-03-27 Fri>}
\begin{itemize}
\item Update to Stan version 2.38.0.
\end{itemize}
