...
\large User's Guide \\  (Torsten Version 0.89rc, Stan version 2.27.0)}
\hypersetup{
 pdfauthor={Yi Zhang},
...
\label{sec:orga783c9b}
\section*{Individuals}
\label{sec:org72bf908}
...
\label{imp_details}
\begin{itemize}
\item Current Torsten v0.89rc is based on Stan v2.27.0.
...
\section{Changelog}
\label{sec:org1481eb8}
\subsection{Version 0.89 \textit{<2021-06-15 Tue>}}
\label{sec:orgdf865b7}
\begin{itemize}
\item Changed
\label{0-85-changed}
\begin{itemize}
...
\item Simplified ODE integrator naming,
e.g. {\small \color{MRGGreen} \texttt{\textbf{pmx\_ode\_bdf}}} and  {\small \color{MRGGreen} \texttt{\textbf{pmx\_ode\_bdf\_ctrl}}}.
\item Update to Stan version 2.27.0.
\end{itemize}
\end{itemize}
\subsection{Version 0.88 \textit{<2020-12-18 Fri>}}
\label{sec:org34e992a}
\begin{itemize}
\item Added
\label{0-85-added}
\begin{itemize}
...
\label{sec:org7188b9b}
\index{One Compartment Model}
\label{sec:onecpt}
\subsection{Description}
\label{sec:org1ae238c}
...
\label{sec:org65f40ad}
\label{sec:twocpt}
\subsection{Description}
\label{sec:orgab75688}
...
\subsection{Arguments}
\label{sec:org6a37094}
See Table \ref{tab:event_args} and Table \ref{tab:event_params}.

\subsection{Return value}
\label{sec:org9122758}
...
\label{sec:org5d3d128}
\subsection{Description}
\label{sec:org8ca5d94}
...
\subsection{Arguments}
\label{sec:org388f46a}
\begin{itemize}
\item {\small \color{MRGGreen} \texttt{\textbf{K}}}
\label{sec:org5a6263b}
...
\label{sec:org3b8ee8d}
\end{itemize}

\subsection{Return value}
\label{sec:org4418930}
...
\label{sec:org206264a}
\label{sec:general_ode}
\subsection{Description}
\label{sec:orgc6b7968}
...
\label{sec:org4b95381}
\index{coupled ODE Model}
\subsection{Description}
\label{sec:orgf84d211}
...
\end{minted}
\item {\small \color{MRGGreen} \texttt{\textbf{nCmt}}}
\label{sec:org3586313}
The number of compartments. Equivalently, the dimension of the ODE system.
\item {\small \color{MRGGreen} \texttt{\textbf{rel\_tol}}}
\label{sec:orgd13b184}
The relative tolerance for numerical integration, default to 1.0E-6.
\item {\small \color{MRGGreen} \texttt{\textbf{abs\_tol}}}
\label{sec:org811a6d2}
The absolute tolerance for numerical integration, default to 1.0E-6.
\item {\small \color{MRGGreen} \texttt{\textbf{max\_step}}}
\label{sec:org200bf53}
The maximum number of steps in numerical integration, default to \(10^6\).
\item See Table \ref{tab:event_args} and Table \ref{tab:event_params} for the rest of arguments.
\label{sec:orgf358655}
\end{itemize}
\subsection{Return value}
\label{sec:org6562786}
...
\label{sec:org7a927ce}
\subsection{Description}
\label{sec:orgba0e7b5}
...
\item {\small \color{MRGGreen} \texttt{\textbf{ODE\_rhs}}}
\label{sec:org7da7aa9}
Same as in Section \ref{sec:general_ode}.
\item {\small \color{MRGGreen} \texttt{\textbf{nCmt}}}
\label{sec:org3e4aa62}
The number of compartments. Equivalently, the dimension of the ODE system.
\item {\small \color{MRGGreen} \texttt{\textbf{x\_r}}}
\label{sec:org16b5a8c}
2d arary real data to be passed to ODE RHS. If specified, its 1st
dimension should have the same size as {\small \color{MRGGreen} \texttt{\textbf{time}}}.
\item {\small \color{MRGGreen} \texttt{\textbf{x\_i}}}
\label{sec:orgf830d47}
2d arary integer data to be passed to ODE RHS. If specified, its 1st
dimension should have the same size as {\small \color{MRGGreen} \texttt{\textbf{time}}}.
\item {\small \color{MRGGreen} \texttt{\textbf{rel\_tol}}}
\label{sec:orgc023f32}
The relative tolerance for numerical integration, default to 1.0E-6.
\item {\small \color{MRGGreen} \texttt{\textbf{abs\_tol}}}
\label{sec:org8cefd4b}
The absolute tolerance for numerical integration, default to 1.0E-6.
\item {\small \color{MRGGreen} \texttt{\textbf{max\_step}}}
\label{sec:org992d4ef}
The maximum number of steps in numerical integration, default to \(10^6\).
\item {\small \color{MRGGreen} \texttt{\textbf{as\_rel\_tol}}}
\label{sec:org0124c26}
The relative tolerance for algebra solver for steady state solution, default to 1.0E-6.
\item {\small \color{MRGGreen} \texttt{\textbf{as\_abs\_tol}}}
\label{sec:org2d101c9}
The absolute tolerance for algebra solver for steady state solution, default to 1.0E-6.
\item {\small \color{MRGGreen} \texttt{\textbf{as\_max\_step}}}
\label{sec:org49978a3}
The maximum number of interations in algebra solver for steady state solution, default to \(10^2\).
\end{itemize}
\subsection{Return value}
\label{sec:org7bb38ff}
An \texttt{nCmt}-by-\texttt{nt} matrix, where \texttt{nt} is the total size of
events \(\sum_{i}n_i\).
\subsection{Note}
\label{sec:org7e8dea2}
...
\label{sec:org67f07cd}
\subsection{Description}
\label{sec:org4391d7d}
...
\end{minted}
\subsection{Arguments}
\label{sec:orgd361e7d}
\label{sec:ode_func_args}
\begin{itemize}
\item {\small \color{MRGGreen} \texttt{\textbf{ODE\_rhs}}}
\label{sec:org6daa3b3}
...
\label{sec:org1a4abfc}
\index{PMX ODE group integrators}
\subsection{Description}
\label{sec:orga72b948}
...
with \(k_{\text{tr}}\) the transit rate constant. In the current example, we use the two compartment model in section \ref{sec:twocpt} for
