...
\label{sec:org9f12f40}
\section*{Individuals}
\label{sec:orgb1cdd4b}
...
\label{sec:orga4b30b7}
\index{One Compartment Model}
\subsection{Description}
\label{sec:org59b6856}
...
\label{sec:org7f51d34}
See Tables in Section \ref{sec:orgd98f2f8}.
\subsection{Return value}
\label{sec:org717ca9f}
...
\label{sec:orgbc8f792}
\subsection{Description}
\label{sec:org25e0260}
...
\subsection{Arguments}
\label{sec:org6396d11}
See Tables in Section \ref{sec:orgd98f2f8}.
\subsection{Return value}
\label{sec:orgeeb9cc0}
...
\label{sec:org4eded64}
\subsection{Description}
\label{sec:org285aa9c}
...
\end{itemize}
\item See Tables in Section \ref{sec:orgd98f2f8} for the rest of arguments.
\end{itemize}
\subsection{Return value}
\label{sec:orgee6b4d7}
...
\label{sec:org6ac486f}
\subsection{Description}
\label{sec:org6aced7d}
...
\subsection{Return value}
\label{sec:org6fba4ee}
An \texttt{nCmt}-by-\texttt{nt} matrix, where \texttt{nt} is the size of \texttt{time}.
\subsection{Note}
\label{sec:org622e9a7}
\begin{itemize}
\item See Section \ref{sec:org9a55d52} for different types of integrator and general guidance.
\item See Section \ref{sec:org9a55d52} for comments on accuracy and tolerance.
...
according to physical intuition and numerical tests. See also Section \ref{sec:org9a55d52}.
...
\label{sec:orgd3297ca}
\index{coupled ODE Model}
\subsection{Description}
\label{sec:orgb23aa58}
...
\label{sec:org023a7a3}
\subsection{Description}
\label{sec:org2bfdec6}
...
\end{minted}
Here \mintinline[breaklines=true,fontsize=\footnotesize,breakanywhere=true]{stan}{[adams || rk45 || bdf]} indicates the
function name can be of any of the three suffixes. See Section \ref{sec:org9a55d52}.
\subsection{Arguments}
\label{sec:org885e25c}
\begin{itemize}
\item \texttt{ODE\_rhs}
Same as in Section \ref{sec:org9a55d52}.
...
entire population (see also Tables in Section \ref{sec:orgd98f2f8}). They must have same size in the first
...
\label{sec:org9a55d52}
\subsection{Description}
\label{sec:orgbdba3f1}
...
\label{sec:org10b6585}
\index{PMX ODE group integrators}
\subsection{Description}
\label{sec:orgceab3cb}
...
\begin{itemize}
\item \texttt{ODE\_rhs}
Function that specifies the right-hand-side \(f\). See Section \ref{sec:org9a55d52}.
\item \texttt{y0}
...
\ref{sec:orgbc8f792}, we simulate \(c\) according to:
\begin{align*}
...
\mintinline[breaklines=true,fontsize=\footnotesize,breakanywhere=true]{stan}{model} block as they are identical to \ref{sec:org85e0cdb} Example.
...
example, we use the \ref{sec:orgbc8f792} for
...
\label{sec:org9350372}
Here we expand the \ref{sec:org85e0cdb} to a population model fitted to the
...
\texttt{TBB\_CXX\_TYPE} to proper C compiler. See also Section \ref{sec:org023a7a3} and \ref{sec:org10b6585}.
