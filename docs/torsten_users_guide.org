...
** General ODE-based Population Model Function
   :PROPERTIES:
   :EXPORT_HUGO_SECTION*: ode_pop
   :EXPORT_FILE_NAME: ode_pop
   :EXPORT_DATE: <2021-06-25 Fri>
   :EXPORT_OPTIONS: toc:t
   :END:
*** Description
...
** ODE  integrator Function
   :PROPERTIES:
   :EXPORT_HUGO_SECTION*: ode_integ
   :EXPORT_FILE_NAME: ode_integ
   :EXPORT_DATE: <2021-06-25 Fri>
   :EXPORT_OPTIONS: toc:t
   :END:
*** Description
...
** ODE group  integrator Function
   :PROPERTIES:
   :EXPORT_HUGO_SECTION*: ode_group_integ
   :EXPORT_FILE_NAME: ode_group_integ
   :EXPORT_DATE: <2021-06-25 Fri>
   :EXPORT_OPTIONS: toc:t
   :END:
...
** Two-compartment model as a linear ODE model for single patient 
   :PROPERTIES:
   :EXPORT_HUGO_SECTION*: twocpt-lin
...
** Two-compartment model solved by numerical integrator for single patient 
   :PROPERTIES:
   :EXPORT_HUGO_SECTION*: twocpt-ode
...
** Linear intepolation
   :PROPERTIES:
   :EXPORT_HUGO_SECTION*: lin-interp
...
- =TORSTEN_MPI=1= turns on within-chain parallelsation of MPI-enable
  ...
  =TBB\_CXX\_TYPE= to proper C compiler. See also section [[ref:sec:ode_group_note]] and [[ref:sec:ode_integ_group_note]].
