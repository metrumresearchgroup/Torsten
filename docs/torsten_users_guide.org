...
# #+HTML_HEAD: <link rel="stylesheet" href="/Users/yiz/Work/tufte-css/tufte.css" type="text/css" />
...
#+INDEX: Friberg-Karlsson Model
   ...
   with $k_{\text{tr}}$ the transit rate constant. In the current example, we use the two compartment model in section [[sec:twocpt]] for
