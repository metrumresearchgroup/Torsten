...
\label{sec:orgb1f2edb}
\section*{Individuals}
\label{sec:org364700b}
...
\label{sec:orgfed6e92}
\label{sec:onecpt}
\subsection{Description}
\label{sec:org5fb03e4}
...
\label{sec:org177d5db}
\label{sec:twocpt}
\subsection{Description}
\label{sec:orgb48339d}
...
\subsection{Arguments}
\label{sec:org22fd79e}
See Table \ref{tab:event_args} and Table \ref{tab:event_params}.

\subsection{Return value}
\label{sec:org91bd0ab}
...
\label{sec:org3ab18a4}
\subsection{Description}
\label{sec:org6ec0ae6}
...
\subsection{Arguments}
\label{sec:org2e164c8}
\begin{itemize}
\item {\small \color{MRGGreen} \texttt{\textbf{K}}}
\label{sec:org8cfcf18}
...
\label{sec:orgde6a739}
\end{itemize}

\subsection{Return value}
\label{sec:org1051bec}
...
\label{sec:orgbce5ca0}
\subsection{Description}
\label{sec:orgbe77f70}
