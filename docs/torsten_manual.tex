...
\label{sec:org24d548f}
\section*{Individuals}
\label{sec:orgb65a5d8}
...
\label{sec:org0ed5c47}
\label{sec:onecpt}
\subsection{Description}
\label{sec:org645f096}
...
\label{sec:orga7da676}
\label{sec:twocpt}
\subsection{Description}
\label{sec:orga0040d9}
...
\subsection{Arguments}
\label{sec:org54e5e92}
See Table \ref{tab:event_args} and Table \ref{tab:event_params}.

\subsection{Return value}
\label{sec:org9867038}
...
\label{sec:org7f89692}
\subsection{Description}
\label{sec:org1bf5c5e}
...
\subsection{Arguments}
\label{sec:org7f5fe07}
\begin{itemize}
\item {\small \color{MRGGreen} \texttt{\textbf{K}}}
\label{sec:org95f4ae8}
...
\label{sec:orgf6cdbb1}
\end{itemize}

\subsection{Return value}
\label{sec:org54dc506}
...
\label{sec:orga1486e9}
\subsection{Description}
\label{sec:orga7a3086}
...
\item See Table \ref{tab:event_args} and Table \ref{tab:event_params} for the rest of arguments.
\label{sec:orgee12b67}
\end{itemize}

\subsection{Note}
\label{sec:org2cff2bf}
\begin{itemize}
...
\label{sec:org83425e6}
\label{sec:mixed}
\index{Mixed ODE Model}
\subsection{Description}
\label{sec:org61c6218}
...
\subsection{Usage}
\label{sec:org286f9e7}
\begin{minted}[breaklines=true,fontsize=\footnotesize,breakanywhere=true]{stan}
matrix pmx_solve_[onecpt || twocpt]_[rk45 || bdf](reduced_ODE_system, int nOde, time, amt, rate, ii, evid, cmt, addl, ss, theta, biovar, tlag [, real rel_tol, real abs_tol, int max_step, real as_rel_tol, real as_abs_tol, int as_max_step ] );
\end{minted}
\subsection{Arguments}
\label{sec:orgd1010ec}
\begin{itemize}
\item {\small \color{MRGGreen} \texttt{\textbf{reduced\_ODE\_rhs}}}
\label{sec:org1da08d8}
...
\end{minted}
\item {\small \color{MRGGreen} \texttt{\textbf{nCmt}}}
\label{sec:orgccca891}
The number of compartments. Equivalently, the dimension of the ODE system.
\item {\small \color{MRGGreen} \texttt{\textbf{rel\_tol}}}
\label{sec:org0cf3565}
The relative tolerance for numerical integration, default to 1.0E-6.
\item {\small \color{MRGGreen} \texttt{\textbf{abs\_tol}}}
\label{sec:orgb27f6d5}
The absolute tolerance for numerical integration, default to 1.0E-6.
\item {\small \color{MRGGreen} \texttt{\textbf{max\_step}}}
\label{sec:org1e4c221}
The maximum number of steps in numerical integration, default to \(10^6\).
\item See Table \ref{tab:event_args} and Table \ref{tab:event_params} for the rest of arguments.
\label{sec:org88cde9b}
\end{itemize}



\section{General ODE-based Population Model Function}
\label{sec:org84f88fc}
\index{General ODE Model}
\begin{minted}[breaklines=true,fontsize=\footnotesize,breakanywhere=true]{stan}
