...
#ifndef PKMODEL_PMETRICS_SOLVER_HPP
#define PKMODEL_PMETRICS_SOLVER_HPP
...
public:
    ...
    pmetrics_solver_structure() //default constructor
    {
        rel_tol = 1e-10;
        abs_tol = 1e-10;
        max_num_steps = 1e8;
    ...
    pmetrics_solver_structure(
    					double p_rel_tol, double p_abs_tol, long int p_max_num_steps, std::string p_solver_type)
    {
    	rel_tol = p_rel_tol;
    	abs_tol = p_abs_tol;
