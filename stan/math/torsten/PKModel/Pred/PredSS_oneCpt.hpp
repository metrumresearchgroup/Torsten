...
Eigen::Matrix<typename boost::math::tools::promote_args< T_time, T_amt, T_rate, 
  typename boost::math::tools::promote_args< T_ii, T_parameters>::type>::type, 1,
  Eigen::Dynamic>  
PredSS_one(const ModelParameters<T_time, T_parameters, T_system>& parameter, 
  ...
  typedef typename boost::math::tools::promote_args< T_time, T_amt, T_rate, 
    typename boost::math::tools::promote_args< T_ii, T_parameters>::type>::type scalar;
  ...
  Eigen::Matrix<scalar, 1, Eigen::Dynamic> pred = Matrix<scalar, 1, Dynamic>::Zero(2); 
