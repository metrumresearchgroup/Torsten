#ifndef STAN_MATH_TORSTEN_FONECPT_HPP
#define STAN_MATH_TORSTEN_FONECPT_HPP
...
RUBISH
  ...
  vector<T_parameters> alpha(2);
  alpha[0] = k10;
  alpha[1] = ka;

  vector<scalar> a(2);
  Matrix<scalar, Dynamic, 1> pred = Matrix<scalar, Dynamic, 1>::Zero(2);
